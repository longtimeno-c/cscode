...
window.bgcolor("dark blue") #changed "sky blue" to "dark blue"
...
text.write("Mrs", font=("Avenir", 30, "bold"), align="right") 
text.color("black") 
text.write("Rogers", font=("Avenir", 30, "normal"), align="left") 
text.setx(50) 
